...
public class HomeArrayAdapter extends ArrayAdapter<Movie> {
	private int view;
	private final Context context;
	private final List<Movie> values;

	public HomeArrayAdapter(Context context, List<Movie> values,
			int view) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		TextView moviePubYear = (TextView) rowView.findViewById(R.id.movieTitle);

		Movie movie = values.get(position);
		movieTitle.setText(movie.getTitle());
		moviePubYear.setText(String.valueOf(movie.getPubYear()));
